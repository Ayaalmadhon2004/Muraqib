...
export function performDeadCodeAudit(targetPath) {
    const reports = [];
    const emptyFunctions = [];
    const unreachableBranches = [];
    const unusedExports = [];
...
//# sourceMappingURL=dead-code-guard.js.map